...
class Agendamento : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.timePicher.setOnTimeChangedListener { _, hourOfDay,  minute, ->
            val minuto: String
        ...
        binding.timePicher.setIs24HourView(true) //formato de 24 horas
        binding.btAgendar.setOnClickListener {
            ...
            when{
                ...
                data.isEmpty() -> {
                    mensagem(it, "Informe uma data", "#FF0000")
                }
                ...
                barbeiro2.isChecked && data.isNotEmpty() && hora.isNotEmpty() -> {
                    salvarAgendamento(it, nome, "Marcos Duarte", data, hora)
                }
                else -> {
